# Thobile Dhlamini - Portfolio Website

Welcome to my personal portfolio website! This site showcases my professional background, skills, projects, and ways to connect with me.

## 📋 About This Portfolio

I am a **data analytics learner (ALX)** and **hospitality professional** with experience in supervision, stock control, and restaurant operations. I am passionate about using technology to solve real-world problems, as demonstrated by my creation of the **KasiKonnect app** — a community-focused platform designed to connect local services and opportunities.

## 🛠️ Skills

- **Hospitality & Operations**: Supervision, stock control, restaurant operations, team management
- **Data Analytics**: Data-driven decision-making, analytical thinking, problem-solving
- **Technology & Development**: App development, community platform design
- **Soft Skills**: Problem-solving, organisational skills, communication, teamwork

## 🚀 Projects

### KasiKonnect
A community-focused platform designed to connect local services and opportunities. This app reflects my interest in using technology to strengthen community bonds.
...
This portfolio is hosted on **GitHub Pages** and is live at:
[https://thobile-bot.github.io/portfolio/](https://thobile-bot.github.io/portfolio/)
...
© 2026 Thobile Dhlamini. All rights reserved.
